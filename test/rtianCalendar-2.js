        ...
        load(year, month) {
            ...
            if (this.showLunar) {
                if (typeof (Lunar) == "undefined") {
                    ...
                    let data = Lunar.solar_yueLi(year, month);
        ...
        renderLunar(days) {
            ...
            for (let i = 0; i < daysdom.length; i++) {
                ...
                if (dom.classList.contains('cday') && idx < days.length + 1) {
                    ...
                    let sd = dinfo['day'];
                    let cy = dinfo['gzYear'];
                    let cm = dinfo['gzMonth'];
                    let cd = dinfo['gzDay'];
                    let str = dinfo['lunarDayCn'];
                    if (str == '初一') {
                        str = dinfo['lunarMonthCn'];
                    ...
                    let cnY = dinfo['lunarYearCn'];
                    let cnM = dinfo['lunarMonthCn'];
                    let cnMdx = dinfo['lunarMonthDX'];
                    let sx = dinfo['zodiacCn'];
                    let cnhtml = `${cnY}\n${cnM}[${cnMdx}]\n${sx}`;
                    dom.title = cnhtml;
