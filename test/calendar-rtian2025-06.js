(function (window) {
    ...
    var
        ...
        solarTerm = "小寒,大寒,立春,雨水,惊蛰,春分,清明,谷雨,立夏,小满,芒种,夏至,小暑,大暑,立秋,处暑,白露,秋分,寒露,霜降,立冬,小雪,大雪,冬至".split(','),
        nStr1 = "日一二三四五六七八九〇",
        nStr2 = "初十廿卅",
        nStr3 = "正二三四五六七八九十冬腊",
        nStr4 = "初十, 二十, 三十".split(','),
    ...
    var lunarCalendar = {
        ...
        getTerm: function (y, m, d) {
            if (!this.sTermInfo["lunar-" + y]) this.getData(y);
